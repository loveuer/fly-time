...
function Sudoku() {
  ...
  const reset = () => { setBoard(sudokuPuzzle); setNotes(Array.from({ length: 81 }, () => [])); setSelected(null); setMistakes(0); setWrongCells([]); setComplete(false); setInputMode('value') }
